...
def draw():
    ...
    if speed_y >= 900 and speed_y <=905 and mouseX >= 900 and mouseX <=1000:
        background_v = False
    if speed_y >= 500 and speed_y <= 505 and mouseX >= 200 and mouseX<= 300:
        background_v = False
    if speed_y >= 700 and speed_y <= 705 and mouseX >= 200 and mouseX <= 300:
        background_v = False
    if speed_y >= 800 and speed_y <= 805 and mouseX >= 800 and mouseX <= 900:
        background_v = False
